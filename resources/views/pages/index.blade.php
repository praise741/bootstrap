                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{$data->p_name}}</div>
                                <div class="portfolio-caption-subheading text-muted">{{$data->p_title}}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">{{$data->p_title}}</p>
                                    <img class="img-fluid d-block mx-auto" src="{{asset('img/'.$data->p_img)}}" alt="" />
